  ...
  const faqs = [
    {
      ...
      answer: "Yes, we provide 1-year warranty on all electronic products and 6 months on accessories."
    },
    {
      question: "What payment methods do you accept?",
      answer: "We accept all major cards, bank transfers, and mobile money payments including Paystack."
    },
    {
    ...
    <div className="w-full min-h-screen overflow-x-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={"/products"} className='flex items-center justify-center'>
              <Button className="text-white px-8 py-3 rounded-full font-semibold hover:text-yellow-500 transition-colors duration-300 flex items-center justify-center gap-2">
                Shop Now <ArrowRight className="w-5 h-5" />
              </Button>
            </Link>

            <Link href={"/about"} className='flex items-center justify-center'>
              <Button className="text-white px-8 py-3 rounded-full font-semibold hover:text-blue-500 transition-colors duration-300 flex items-center justify-center gap-2">
      ...
      <section className="py-8">
        <div className="max-w-6xl mx-auto px-4 md:px-6 mb-8">
          <h2 className="text-3xl font-bold text-center mb-4 text-black">Featured Products</h2>
          <p className="text-gray-600 text-center">Discover our most popular tech items</p>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold text-center mb-4 text-black">Why Choose Cyfa Tech?</h2>
          <p className="text-gray-600 text-center mb-12">We make tech shopping simple and reliable</p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-yellow-500 to-blue-400 rounded-2xl p-12 text-white">
            ...
            <p className="text-xl text-blue-50 mb-8 max-w-2xl mx-auto">
              Experience the future of tech today — add your favorites to your cart and head to checkout to make them yours.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
