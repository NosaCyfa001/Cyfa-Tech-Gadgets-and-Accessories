    ...
    <div className="container mx-auto px-4 py-6 sm:py-10 max-w-6xl">
      ...
      <div className="flex items-center justify-between mb-6 sm:mb-8">
        ...
        <Button
          ...
          size="sm"
          onClick={clearCart}
          className="bg-gray-900 text-white border-0 px-8 py-3 rounded-full font-semibold shadow-lg hover:bg-gray-700 hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-2"
        >
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        <div className="flex items-center gap-2 sm:gap-3">
                          {/* FIXED: – button matches clear cart style */}
                          <Button
                            variant="default"
                            size="sm"
                            onClick={() => removeItem(item.id)}
                            className="rounded-full w-8 h-8 p-0 text-base bg-gray-900 text-white border-0 shadow-sm hover:bg-gray-700 hover:scale-105 active:scale-95 transition-all duration-300"
                          >
                            –
                          </Button>
        ...
        <div className="lg:col-span-1">
          <Card className="shadow-sm border border-gray-200 rounded-lg sticky top-4">
            ...
            <CardContent className="px-4 sm:px-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="w-full rounded border px-4 py-2 bg-white text-black focus:outline-none focus:ring-2"
                  />
                  {/* FIXED: Apply button matches clear cart style */}
                  <Button
                    type="button"
                    onClick={handleApplyPromo}
                    disabled={promoApplied}
                    className="bg-gray-900 text-white border-0 px-4 rounded-full font-semibold shadow-sm hover:bg-gray-700 hover:scale-105 active:scale-95 transition-all duration-300 disabled:opacity-50 disabled:hover:scale-100"
                  >
                    Apply
                  </Button>
                </div>
              ...
              {/* FIXED: Proceed to Payment matches clear cart style */}
              <form action={checkoutAction} className="pt-2">
                ...
                <Button
                  type="submit"
                  className="w-full bg-gray-900 text-white border-0 py-3 rounded-full font-semibold shadow-lg hover:bg-gray-700 hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300 flex items-center justify-center gap-2"
                >
